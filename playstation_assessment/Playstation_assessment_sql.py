...
def get_dataframes(spark):
    ...
    place_details_df=spark.table("rubric.Dim_restaurant_profile_details")

    user_details_df=spark.table("rubric.Dim_user_profile_details") 

    user_visit_details_df=spark.table("rubric.Fact_user_visit_details")
