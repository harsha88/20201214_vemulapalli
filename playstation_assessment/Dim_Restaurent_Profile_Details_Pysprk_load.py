# This code is for loading the data into dim_restaurant_profile_details table from the placedeatils file.
...
def updatePlaceDetails(spark,inputpath):
    ...
    if placeDetails_df.limit(1).count() > 0:
        ...
        fullPlaceDetails_df=spark.table("rubric.dim_restaurant_profile_details").withColumn("ind",lit(2))
        ...
        latestPlaceProfileDetails_df.write.mode(SaveMode.Overwrite).insertInto("rubric.dim_restaurant_profile_details")
